...
// ---------------------------------------------------------------------------
// Scanner IPC message types (JSON-based, used by rps-pluginscanner)
// Pluginhost IPC messages have migrated to proto/host.proto (protobuf-based).
// ---------------------------------------------------------------------------
...
// Wrapper for any scanner message
struct Message {
    MessageType type;
